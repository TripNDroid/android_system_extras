...
#define ANDROID_ROOT_ACCESS_DISABLED      0
#define ANDROID_ROOT_ACCESS_APPS_ONLY     1
#define ANDROID_ROOT_ACCESS_ADB_ONLY      2
#define ANDROID_ROOT_ACCESS_APPS_AND_ADB  3
